...
class SyntheticTestFun:
    ...
    def __init__(self, name, d, noise):
        ...
        match name:
            case 'hartmann':
                ...
                self.f = Hartmann(noise_std=noise)
            case 'ackley':
                self.f = Ackley(d, noise_std=noise)
            case 'grienwank':
                self.f = Griewank(d, noise_std=noise)
            case 'michaelwicz':
                self.f = Michalewicz(d, noise_std=noise)
