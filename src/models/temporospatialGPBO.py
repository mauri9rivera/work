...
### GPBO ###
def temporospatialGPBO(GP_model, this_opt, options=None):
        ...
        for rep_i in range(nRep): # for each repetition
            ...
            while q < MaxQueries:
                ...
                if q==0:
                    ...
                    model = GP_model(x, y, likf, lengthscale_prior, 3, 2) #model = KernelLearningGP(x, y, likf, partition, kernel_priors=priorboxes)
